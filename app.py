...
#블랍스토리지로 패스 변경
TEMPLATE_PATH = "C:/Users/goldh/smart_captureplan/CapturePlan_Template.xlsx"
OUTPUT_PATH = "C:/Users/goldh/smart_captureplan/CapturePlan_Template.xlsx"
    ...
    with st.spinner("🤖 문서 분석 중..."):
        ...
        if extracted:
            ...
            with open(OUTPUT_PATH, "rb") as f:
                st.download_button("📥 결과 엑셀 다운로드", f, file_name="결과_캡처플랜.xlsx")
        else:
